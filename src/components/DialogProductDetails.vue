  ...
  >
    <q-card>
      ...
      <q-card-section>
        ...
        <div class="text-doby2" v-html="product.description" />
      </q-card-section>
      <q-card-actions>
...
export default defineComponent({
  ...
  setup (props, { emit }) {
    ...
    const handleSendWpp = () => {
      const link = encodeURI(`https://api.whatsapp.com/send?phone=55${brand.value.phone}&text=${msg} - ${props.product.name} - ${props.product.price}`)
      openURL(link)
    }
